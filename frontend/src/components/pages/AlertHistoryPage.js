            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-heading font-bold text-sm text-white">
                  {language === 'it' ? 'Modalità V3-Only Attiva' : 'V3-Only Mode Active'}
                </span>
              ...
              <p className="text-xs text-zinc-500 mt-0.5">
                {language === 'it' 
                  ? 'Solo segnali V3 Multi-Timeframe vengono registrati. Dati legacy archiviati.'
                  : 'Only V3 Multi-Timeframe signals are recorded. Legacy data archived.'}
              </p>
            </div>
          </div>
          <div className="text-right">
            <div className="text-xs text-zinc-500">
              {language === 'it' ? 'Segnali Archiviati' : 'Archived Signals'}
            </div>
            <div className="text-sm font-mono text-zinc-400">340</div>
          </div>
        </div>
      </div>
